...
//                     <Image src="/images/howITWorkB.jpg" alt="this is car" fill className="object-cover rounded-[24px] px-4 lg:px-0" />
//                 </div>
...
//                                     </div>
//                                     <h1 className="text-2xl lg:text-[30px] font-semibold text-[#131927]">Submission & Review</h1>
//                                 </div>
...
//                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-18 items-center">
//                         <div>
//                             <Image className="rounded-[24px]" src="/images/Conditional.jpg" alt="" width={650} height={445} />
//                         </div>
//                         <div>
//                             <div className="">
//                                 <div className="flex items-center gap-4">
//                                     <div className="bg-black p-3 rounded-full">
//                                         <Image src="/images/icon2.svg" width={28} height={28} alt="" />
//                                     </div>
//                                     <h1 className="text-2xl lg:text-[30px] font-semibold text-[#131927]">Conditional Offers for Remote Vehicles</h1>
//                                 </div>
//                                 <p className="mt-3.5">Receive a preliminary offer even if your vehicle is not nearby. Our team reviews the details you submit and gives you a conditional price instantly.</p>
//                             </div>
//                             <div className="mt-6 space-y-3">
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Quick response within 24 hours</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>No obligation to accept</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Remote submissions fully supported</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
...
//                                         <Image src="/images/Icon1.svg" width={28} height={28} alt="" />
//                                     </div>
//                                     <h1 className="text-2xl lg:text-[30px] font-semibold text-[#131927]">Pickup Verification</h1>
//                                 </div>
//                                 <p className="mt-3.5">Once you accept the offer, we schedule a pickup and verify the vehicle or asset in person to ensure everything matches your submission.</p>
//                             </div>
//                             <div className="mt-6 space-y-3">
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Convenient scheduling at your location</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Verification ensures accurate payment</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Professional staff handles inspection</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Minimal disruption to your day</h2>
//                                 </div>
//                             </div>
//                         </div>
//                         <div>
//                             <Image className="rounded-[24px]" src="/images/pickup.png" alt="" width={650} height={445} />
//                         </div>
//                     </div>
//                 </div>
//                 <div className="mt-15 px-4 lg:px-0">
//                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-18 items-center">
//                         <div>
//                             <Image className="rounded-[24px]" src="/images/Payment.jpg" alt="" width={650} height={445} />
//                         </div>
//                         <div>
//                             <div className="">
//                                 <div className="flex items-center gap-4">
//                                     <div className="bg-black p-3 rounded-full">
//                                         <Image src="/images/Icon3.svg" width={28} height={28} alt="" />
//                                     </div>
//                                     <h1 className="text-2xl lg:text-[30px] font-semibold text-[#131927]">Payment Timing (at Pickup Verification)</h1>
//                                 </div>
//                                 <p className="mt-3.5">Receive your payment immediately after verification. We make sure the transaction is secure and transparent, so you get your funds without delay.</p>
//                             </div>
//                             <div className="mt-6 space-y-3">
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Instant payment after verification</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
...
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Clear confirmation receipt</h2>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//                                 <div className="flex items-center gap-4">
//                                     <div className="bg-black p-3 rounded-full">
//                                         <Image src="/images/Icon4.svg" width={28} height={28} alt="" />
//                                     </div>
//                                     <h1 className="text-2xl lg:text-[30px] font-semibold text-[#131927]">Transport Handled Professionally</h1>
//                                 </div>
//                                 <p className="mt-3.5">After verification and payment, our logistics team ensures your vehicle or asset is transported safely to its next destination, handled by trained professionals.</p>
//                             </div>
//                             <div className="mt-6 space-y-3">
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Safe and reliable transport</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Experienced drivers and handlers</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
//                                     <h2>Real-time updates available</h2>
//                                 </div>
//                                 <div className="flex gap-3">
//                                     <CircleCheckBig className="text-[#D93E39]" />
...
//                         </div>
//                         <div>
//                             <Image className="rounded-[24px]" src="/images/Transport.png" alt="" width={650} height={445} />
//                         </div>
//                     </div>
//                 </div>
//             </div>
