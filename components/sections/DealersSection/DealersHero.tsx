...
//             <div className="relative w-full h-30 sm:h-40 md:h-45 lg:h-104 rounded-xl overflow-hidden">
...
//                         <button className="text-white text-[12px] py-1 px-4 cursor-pointer w-52.75 bg-[#D93E39] rounded-[9999px] font-semibold uppercase">
//                             Automotive Authority
//                         </button>
//                         <h2 className="text-[#FDECEC] text-[60px] font-bold leading-18">
//                             Dealer Buyer <br /> Network
//                         </h2>
//                         <p className=" text-[rgba(253,236,236,0.9)] text-[20px] leading-6.5">
//                             VinToCash sources vehicles directly from private sellers. <br />
//                             Qualified dealers may receive select off-market <br />
...
//                         <button className="text-[18px] bg-[#D93E39] text-white cursor-pointer font-bold py-2.5 px-6 rounded-[100px]">
//                             Apply for Access
//                         </button>
//                         <span className="text-[#D93E39] text-[18px] font-bold">
