...
//                 {/* left side */}
//                 <div>
//                     <Image className="rounded-[24px]" src="/images/dealernet.jpg" width={650} height={200} alt="images" />
//                 </div>
//                 {/* right side */}
//                 <div>
...
// const DealerNetwork = () => {
//   return (
//     <section className="w-full bg-white px-4 py-10 sm:px-6 sm:py-14 lg:px-16 lg:py-20">
...
//           {/* Heading */}
//           <h2 className="text-[#1A1A2E] text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight">
...
//               {/* Number badge */}
//               <div className="shrink-0 w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#D93E39] flex items-center justify-center">
...
//                 <h3 className="text-[#1A1A2E] text-[15px] sm:text-[16px] font-bold leading-snug">
//                   {step.title}
//                 </h3>
